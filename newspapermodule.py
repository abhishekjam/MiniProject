...
def mainmodule(url):
    ...
    file = open("/home/abhishek/Desktop/Mini Project/Newspaper with gui/output.html", "w")
    file.write("<h1>")
    file.write("<center>")
    file.write(result1)
    file.write("</center>")
    ...
    webbrowser.open('/home/abhishek/Desktop/Mini Project/Newspaper with gui/output.html')
