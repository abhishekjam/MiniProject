...
def contact():
   tkMessageBox.showinfo("--------------------Contact Us--------------------", "Abhishek Kumar:-+919444133790\nEmail-Id:- abhishekcomspu@gmail.com")
def onclick2():
...
titlelabel = Label(topframe, text="WELCOME TO THE e-NEWSPAPER WEB SCRAPPING SYSTEM", font=('Rockwell Extra Bold', 23, 'bold','underline'), fg="saddle brown",compound=TOP)
titlelabel.configure(background = '#e1d8b9')
titlelabel.pack(anchor=N)
titlelabel1 = Label(topframe, text="Life is really simple, but we insist on making it complicated", font=('Rockwell Extra Bold', 20, 'bold','underline'), fg="saddle brown",compound=TOP)
titlelabel1.configure(background = '#e1d8b9')
titlelabel1.pack(anchor=N)
titlelabel2 = Label(topframe, text="*Source**Service**Solution*", font=('Rockwell Extra Bold', 18, 'bold','underline'), fg="saddle brown",compound=TOP)
...
thelabel3 = Label(leftframe, text="Please Select The Desired Option From Given Link", font=('Cooper Black', 15,'underline'), fg="midnight blue",compound=TOP)
...
#------------Radio Button------------------
btn1 = StringVar()
R1 = Radiobutton(leftframe, text="https://www.bbc.com", variable="btn1", value="https://www.bbc.com", fg="black", font=(10))
R1.configure(background = '#e1d8b9')
R1.pack(anchor = N)
R2 = Radiobutton(leftframe, text="https://www.cnn.com", variable="btn1", value="https://www.cnn.com", fg="black", font=(10))
R2.configure(background = '#e1d8b9')
R2.pack(anchor = N)
R3 = Radiobutton(leftframe, text="https://www.hindustantimes.com", variable="btn1", value="https://www.hindustantimes.com", fg="black", font=(10))
R3.configure(background = '#e1d8b9')
R3.pack(anchor = N)
R4 = Radiobutton(leftframe, text="https://www.timesofindia.indiatimes.com", variable="btn1", value="https://www.timesofindia.indiatimes.com", fg="black", font=(10))
R4.configure(background = '#e1d8b9')
R4.pack(anchor = N)
R5 = Radiobutton(leftframe, text="https://www.thehindu.com", variable="btn1", value="https://www.thehindu.com", fg="black", font=(10))
...
thelabel10 = Label(rightframe, text="Enter The Any Specific Url For Which You Want to check", font=('Cooper Black', 15,'underline'), fg="midnight blue", compound=TOP)
...
textbox.pack(anchor=N)
thelabel13 = Label(rightframe)
thelabel13.pack(anchor=E)
thelabel14 = Label(rightframe)
thelabel14.pack(anchor=E) 
button2 = Button(rightframe, text="View Result", font=('Cooper Black', 9), fg="red", bg="white", bd=10, command=onclick2)
