...
img = ImageTk.PhotoImage(Image.open("/home/abhishek/Desktop/Mini Project/Newspaper with gui/download.jpg"))
panel = Label(topframe, image = img, compound=LEFT)
panel.configure(background = '#e1d8b9')
panel.pack(side = "left", fill = "both", expand = "1")

titlelabel = Label(topframe, text="WELCOME TO THE e-NEWSPAPER WEB SCRAPPING SYSTEM", font=('Noto Sans CJK TC Black', 21, 'bold','underline'), fg="saddle brown",compound=TOP)
